...
type AbstractController interface {
	...
	AdmActorDuplicates(*gin.Context)
	AdmActorDuplicateDismiss(*gin.Context)
	AdmActorDuplicateDismissRemove(*gin.Context)
	AdmActorDuplicateDismissedList(*gin.Context)
	...
	AdmConfigReorganizeOnImportUpdate(*gin.Context)
	AdmOrganizationList(*gin.Context)
	AdmOrganizationCreate(*gin.Context)
	AdmOrganizationUpdate(*gin.Context)
	AdmOrganizationDelete(*gin.Context)
	AdmOrganizationActivate(*gin.Context)
	AdmOrganizationReorganize(*gin.Context)
