...
func (c *Controller) GenericVideoAjaxActors(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoAjaxComputeDuration(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoAjaxGenerateThumbnail(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoAjaxGenerateThumbnailXS(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoEdit(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoView(videoType string, g *gin.Context) {
	// get id from path
	id := g.Param("id")
	...
	result := c.datastore.Preload("Actors").First(clip)
...
func (c *Controller) GenericVideoStream(videoType string, g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoAjaxStreamInfo(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoThumb(videoType string, g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoThumbXS(videoType string, g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
type GenericVideoAjaxRenameForm struct {
	Name string `form:"name"`
}

func (c *Controller) GenericVideoAjaxRename(g *gin.Context) {
	...
	var form GenericVideoAjaxRenameForm
...
func (c *Controller) GenericVideoAjaxImport(g *gin.Context) {
	// get id from path
	id := g.Param("id")
...
func (c *Controller) GenericVideoAjaxCreate(g *gin.Context) {
	var err error
...
func (c *Controller) GenericVideoAjaxUploadThumb(g *gin.Context) {
	// get id from path
	id := g.Param("id")
	...
	// generate mini thumb
	c.GenericVideoAjaxGenerateThumbnailXS(g)
}

func (c *Controller) GenericVideoAjaxUpload(g *gin.Context) {
	// get id from path
	id := g.Param("id")
